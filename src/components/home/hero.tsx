...
export function Hero() {
  ...
  return (
    <section id='home' className='relative min-h-screen w-full flex flex-col lg:flex-row max-w-7xl items-center justify-center overflow-hidden px-4 lg:px-6 text-center lg:text-left'>
      ...
      >
        ...
        >
          <span className="text-sm md:text-base font-medium text-primary bg-primary/10 px-3 py-1 rounded-full border border-primary/20">
            👋 Hello, I'm
          </span>
        </motion.div>
        ...
        >
          ...
          <Button 
            ...
            variant="outline" 
            size="lg"
            className='px-8 py-3 rounded-full border-2 hover:bg-accent hover:text-accent-foreground transition-all duration-300 hover:-translate-y-1'
          >
            About Me
          </Button>
        </motion.div>
        ...
        >
          ...
          <div className="flex gap-3">
            {[
              ...
              { icon: Mail, href: "mailto:bhilbis123@gmail.com", label: "Email" }
            ].map((social, index) => (
              <motion.a
                key={social.label}
                href={social.href}
